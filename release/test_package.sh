...
function test_package_not_package_jakarta_transform_dependencies {
	...
	_test_package_not_package_jakarta_transform_dependencies "2025.q4.1"
	_test_package_not_package_jakarta_transform_dependencies "2026.q1.1-lts"
	_test_package_not_package_jakarta_transform_dependencies "7.3.10-ga1"
	_test_package_not_package_jakarta_transform_dependencies "7.4.13-u149"

	rm --force --recursive "${_PROJECTS_DIR}"

	_test_package_not_package_jakarta_transform_dependencies "2026.q1.0-lts"
	_test_package_not_package_jakarta_transform_dependencies "2026.q3.0"
