...
function build_bundle_image {
	...
	then
		bundle_url="releases-cdn.liferay.com/dxp/release-candidates/${_PRODUCT_VERSION}-${_BUILD_TIMESTAMP}/"$(curl -fsSL "https://releases-cdn.liferay.com/dxp/release-candidates/${_PRODUCT_VERSION}-${_BUILD_TIMESTAMP}/.lfrrelease-tomcat-bundle")
	elif is_release_candidate && is_ga_release
	then
		bundle_url="releases-cdn.liferay.com/portal/release-candidates/${_PRODUCT_VERSION}-${_BUILD_TIMESTAMP}/"$(curl -fsSL "https://releases-cdn.liferay.com/portal/release-candidates/${_PRODUCT_VERSION}-${_BUILD_TIMESTAMP}/.lfrrelease-tomcat-bundle")
	fi
